...
export const selectFuseDialogState = appSelector(
  (state: AppRootStateType) => state.fuseDialog.open,
)

export const selectFuseDialogProps = appSelector(
  (state: AppRootStateType) => state.fuseDialog,
)

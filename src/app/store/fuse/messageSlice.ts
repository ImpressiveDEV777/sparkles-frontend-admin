...
type initialStateProps = {
  ...
  options: Pick<
    SnackbarProps,
    'anchorOrigin' | 'autoHideDuration' | 'message'
  > & {
...
export const selectFuseMessageState = (state: AppRootStateType) =>
  state.fuse.message.state

export const selectFuseMessageOptions = (state: AppRootStateType) =>
  state.fuse.message.options

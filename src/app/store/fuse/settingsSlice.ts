...
const getDirection = (state: AppRootStateType) =>
  state.fuse.settings.current.direction
const getMainTheme = (state: AppRootStateType) =>
  state.fuse.settings.current.theme.main
const getNavbarTheme = (state: AppRootStateType) =>
  state.fuse.settings.current.theme.navbar
const getToolbarTheme = (state: AppRootStateType) =>
  state.fuse.settings.current.theme.toolbar
const getFooterTheme = (state: AppRootStateType) =>
  state.fuse.settings.current.theme.footer
...
export const selectFuseCurrentSettings = (state: AppRootStateType) =>
  state.fuse.settings.current

export const selectFuseCurrentLayoutConfig = (state: AppRootStateType) =>
  state.fuse.settings.current.layout.config

export const selectFuseDefaultSettings = (state: AppRootStateType) =>
  state.fuse.settings.defaults

export const selectCustomScrollbarsEnabled = (state: AppRootStateType) =>
  state.fuse.settings.current.customScrollbars
